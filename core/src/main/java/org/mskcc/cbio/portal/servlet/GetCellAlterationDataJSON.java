...
public class GetCellAlterationDataJSON extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest httpServletRequest,
        ...
        try {
            ...
            CellProfile final_gp = DaoCellProfile.getCellProfileByStableId(profileId);
            ...
            for (String cellId: cellIdList) {
                //ArrayList<ObjectNode> _cellArr = new ArrayList();
                ArrayNode _cellArr = new ArrayNode(factory);
                ArrayList<String> tmpProfileDataArr = 
                            CellAlterationUtil.getCellAlterationDataRow(
                                daoCellOptimized.getCell(cellId), 
                                sampleIds, 
                                final_gp
                            );
                ...
                ((ObjectNode)_result).put(cellId, _cellArr);
            }
